...
The same stack is also implemented in [R](https://github.com/jMotif/jmotif-R) (the `jmotif` package, **1.3.2**, on [CRAN](https://cran.r-project.org/package=jmotif)), [Java](https://github.com/jMotif/SAX), [sax-vsm_classic](https://github.com/jMotif/sax-vsm_classic) ([docs](https://jmotif.github.io/sax-vsm_site/)), and [GrammarViz 3.0](https://grammarviz2.github.io/grammarviz2_site/) ([source](https://github.com/GrammarViz2/grammarviz2_src)). saxpy is the **reference Python** port — see the next section.
